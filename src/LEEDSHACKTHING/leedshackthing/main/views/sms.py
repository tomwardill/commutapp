...
class SMS(object):
    ...
    def post(self, recipient, message):
        ...
        if recipient and message:
            ...
            xml = """<?xml version='1.0' encoding='UTF-8'?><messages><accountreference>%s</accountreference><message><from>Commutr</from><to>%s</to><body>%s</body></message></messages>""" % ('EX0081171', recipient, message)  
