...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.growlkey'
        db.add_column('main_userprofile', 'growlkey', self.gf('django.db.models.fields.CharField')(default='', max_length=41, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.growlkey'
        db.delete_column('main_userprofile', 'growlkey')
