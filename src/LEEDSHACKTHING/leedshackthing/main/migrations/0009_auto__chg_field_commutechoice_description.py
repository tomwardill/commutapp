...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CommuteChoice.description'
        db.alter_column('main_commutechoice', 'description', self.gf('django.db.models.fields.CharField')(max_length=9))


    def backwards(self, orm):
        
        # Changing field 'CommuteChoice.description'
        db.alter_column('main_commutechoice', 'description', self.gf('django.db.models.fields.CharField')(max_length=8))
