...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnplannedEvent.updated'
        db.add_column('main_unplannedevent', 'updated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UnplannedEvent.updated'
        db.delete_column('main_unplannedevent', 'updated')
