...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UnplannedEvent.small_description'
        db.add_column('main_unplannedevent', 'small_description', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'UnplannedEvent.impact'
        db.add_column('main_unplannedevent', 'impact', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'UnplannedEvent.small_description'
        db.delete_column('main_unplannedevent', 'small_description')

        # Deleting field 'UnplannedEvent.impact'
        db.delete_column('main_unplannedevent', 'impact')
